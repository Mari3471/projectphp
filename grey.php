      ...
      <div class="row">
        <div class="col-1">
          ...
          <button class="buy" type="button">
            <a
              href="https://www.3djake.cz/3djake/ecopla-dark-grey"
        ...
        <div class="col-2">
          <img src="filaments/filament.jpg" class="filament" alt="green" />
        </div>
      </div>
      <p class="txtchoose">Choose colour:</p>
      <a href="white.php"><img src="images/white.jpg" class="choose" /></a>
      <a href="lightgrey.php"
        ><img src="images/lightgrey.jpg" class="choose"
      /></a>
